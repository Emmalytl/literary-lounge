      ...
      <footer className="border-t border-ink/10 dark:border-ink-dark/10 mt-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 md:py-5 flex flex-wrap items-center gap-x-5 gap-y-2 md:grid md:grid-cols-5 md:gap-6 text-sm">
          <div className="flex basis-full items-baseline gap-2 md:col-span-2 md:block md:basis-auto">
            <p className="font-display text-lg md:mb-1">The Literary Lounge</p>
            <p className="opacity-70">Read. Discuss. Connect.</p>
          </div>
          <div className="flex items-center gap-1"><p className="font-medium">About</p><Link to="/">Our story</Link></div>
          <div className="flex items-center gap-1"><p className="font-medium">Library</p><Link to="/library">Browse books</Link></div>
          <div className="flex items-center gap-1"><p className="font-medium">Membership</p><Link to="/membership">Dues & benefits</Link></div>
        </div>
      </footer>
    </div>
  )
